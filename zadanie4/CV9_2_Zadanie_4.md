...
1: Pri použití spermanovho korelačného koeficientu je najvyššia negatívna korelácia medzi premennými Bin.7.66 a Bin.0.86, koeficient korelácie je -0.755.
2: Na hladine významnosti p=0,0005 pri využití t-testu je 51 vzoriek štatisticky významných, čo naznačuje, že medzi skúmanými skupinami pre tieto vzorky existuje významný rozdiel.
3: Tretia skutočnosť je, že prostredníictvom pearsonovej metriky a následne algoritmom zhlukovania Ward’s linkage výsledný dendogram ukázal, že dáta sú takmer presne rozdelené do 2 skupín - pacienti a kontroly. V časti s kontrolami došlo k jemnému prekryvu pacientov P113 a P099, ale vetva pacientov je čistá. 
4: Využitím PCA analýzy som zistil, že prvé 2 PC1 a PC2 rozdeľujú čiastočne pacientov od kontrol a ostatné PC3–PC5 nie su moc významné, ale môžu pomôcť nájsť podskupiny alebo výnimočné vzorky. Celkovo všetky PC dosahujú PC index 50%.
