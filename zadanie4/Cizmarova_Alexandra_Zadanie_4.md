...
1: PCA analýza ukazuje, že vzorky zo skupiny 'severe kidney disease' a 'control' sú do určitej miery oddelené podľa hlavnej komponenty PC1, čo naznačuje rozdielne metabolické profily.
2: PLS-DA identifikovala binty Bin.0.82, Bin.2.54 a Bin.2.70 ako najvýznamnejšie pre diskrimináciu medzi skupinami, s VIP skóre vyšším než 2.1.
3: T-test odhalil štatisticky významný rozdiel pre Bin.0.82 medzi skupinami (p = 6.08×10⁻¹³), čo naznačuje silný rozdiel v koncentrácii tohto metabolitu.
4: Najvyššia pozitívna korelácia bola medzi Bin.7.62 a Bin.7.82, s Pearsonovým korelačným koeficientom 0.965, čo naznačuje podobné správanie týchto dvoch metabolitov.
5: Dendrogram odhalil dve výrazne odlišné skupiny vzoriek, ktoré zodpovedajú skupine 'control' a 'severe kidney disease', čo podporuje existenciu významných rozdielov v metabolickom profile týchto skupín.
