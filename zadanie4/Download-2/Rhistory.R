...
mSet<-PlotStaticCorrHeatMap(mSet, "corr_1_", "png", 72, width=NA, "col", "pearson", "bwm", "overview", F, F, 0.05)
mSet<-PlotStaticCorrHeatMap(mSet, "corr_1_", "png", 300, width=NA, "col", "pearson", "bwm", "overview", F, F, 0.05)
