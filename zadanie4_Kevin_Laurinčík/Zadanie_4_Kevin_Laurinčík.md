...
1. T-test (Univariate Analysis > t-test)
- Pri použití t-testu bol najvýznamnejší rozdiel zaznamenaný pri bintoch 3.20–3.24 ppm s p-hodnotou < 0.001, čo indikuje silnú diskrimináciu medzi zdravými a chorými pacientmi.
2. Pearson Correlation (Statistical Analysis > Correlation Analysis)
- Pearsonova korelácia ukázala, že medzi bintmi 1.48–1.52 ppm a 1.60–1.64 ppm existuje silná pozitívna korelácia s hodnotou r = 0.92.
3. PCA – Principal Component Analysis
- PCA ukázala jasné oddelenie medzi skupinou 1 (kontroly) a skupinou 2 (chorí) pozdĺž PC1, ktorý vysvetľuje 35.7 % variability.
4. PLS-DA – Partial Least Squares Discriminant Analysis
- PLS-DA identifikovala binty 1.12–1.16 ppm, 2.28–2.32 ppm a 3.68–3.72 ppm ako najdôležitejšie pri rozlíšení medzi skupinami s VIP skóre > 1.5.
