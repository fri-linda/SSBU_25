...
Vybral som model `RandomForestClassifier` z knižnice `sklearn.ensemble`. Nastavil som tieto parametre : 
...
Pri nizsom pocte replikacii (10) random forest dosahoval lepsiu precision a accuracy. Avsak pri vacsom pocte replikacii(50) sa tieto hodnoty takmer zhoduju. 
