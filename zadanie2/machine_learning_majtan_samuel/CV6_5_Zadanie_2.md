...
RandomForestClassifier model s parametrami n_estimators = [50, 100, 200], max_depth = [None, 5, 10] a min_samples_split = [2, 5]
...
Celkovo sa ako najlepsi model ukazala logisticka regresia ktora dosiahla vysie priemery napriec metrikami: f1 score a roc auc. Bola o cosi malo stabilnejsia v porovnaní s random forest, ktory mal ~ vacsi rozptyl medzi jednotlivymi replikaciami.
