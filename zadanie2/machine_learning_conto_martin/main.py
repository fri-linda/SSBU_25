...
def initialize_models_and_params():
    ...
    return models, param_grids, n_replications


def run_experiment(dataset, models, param_grids, n_replications, logger):
    """
    ...
    experiment = Experiment(models, param_grids, n_replications, logger=logger)
...
def main():
    ...
    models, param_grids, n_replications = initialize_models_and_params()
    experiment, results = run_experiment(dataset, models, param_grids, n_replications, logger)
